    ...
    <div className="bg-[#FDFBF7] min-h-screen py-16 px-4 sm:px-6 lg:px-8 font-sans" id="contact-view-container">
      <div className="max-w-6xl mx-auto space-y-20">
        ...
        <div className="text-center space-y-3">
          <span className="text-[10px] tracking-[0.25em] uppercase text-brand-gold font-bold">{t("contact_header_badge")}</span>
          <h1 className="serif-heading text-3xl sm:text-5.5xl text-brand-maroon font-serif font-light leading-tight">{t("contact_header_title")}</h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start">
          ...
          <div className="lg:col-span-5 space-y-8 animate-fade-in text-brand-maroon">
            <h2 className="serif-heading text-2xl font-serif text-brand-maroon tracking-wide">{t("contact_coords")}</h2>

            <div className="space-y-6">
              <div className="flex items-start space-x-4">
                <MapPin className="w-5 h-5 text-brand-gold flex-shrink-0 mt-1" />
                <div className="space-y-1 text-xs">
                  <strong className="block text-brand-maroon uppercase tracking-wide">{t("contact_address_label")}</strong>
                  <span className="text-brand-warm-gray block">{t("contact_address_val")}</span>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div className="space-y-1 text-xs">
                  <strong className="block text-brand-maroon uppercase tracking-wide">{t("contact_phone_label")}</strong>
                  <span className="text-brand-warm-gray block font-mono underline">{t("contact_phone_val")}</span>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div className="space-y-1 text-xs">
                  <strong className="block text-brand-maroon uppercase tracking-wide">{t("contact_email_label")}</strong>
          ...
          <div className="lg:col-span-7 bg-[#FAF7F2] border border-brand-gold/25 p-8 sm:p-10">
            <h2 className="serif-heading text-2xl font-serif text-brand-maroon tracking-wider mb-2">{t("contact_book_sitting")}</h2>
            ...
            <form onSubmit={handleSubmit} className="space-y-4 text-xs">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="space-y-1.5">
                  <label htmlFor="contact-name" className="text-[10px] text-brand-maroon font-bold uppercase tracking-wider block">{t("contact_form_name")}</label>
                  <input
                    type="text"
                    required
                    value={formInp.name}
                ...
                <div className="space-y-1.5">
                  <label htmlFor="contact-email" className="text-[10px] text-brand-maroon font-bold uppercase tracking-wider block">{t("contact_form_email")}</label>
                  <input
                    type="email"
                    required
                    value={formInp.email}
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="space-y-1.5">
                  <label htmlFor="contact-phone" className="text-[10px] text-brand-maroon font-bold uppercase tracking-wider block">{t("contact_form_phone")}</label>
                  <input
                    type="tel"
                    placeholder="+91..."
                    value={formInp.phone}
                ...
                <div className="space-y-1.5">
                  <label htmlFor="sitting-type" className="text-[10px] text-brand-maroon font-bold uppercase tracking-wider block">{t("contact_form_type")}</label>
                  <select
                    ...
                    id="sitting-type"
                  >
                    <option value="bridal">{t("contact_type_bridal")}</option>
                    <option value="heritage">{t("contact_type_heritage")}</option>
                    <option value="standard">{t("contact_type_standard")}</option>
                  </select>
                </div>
              </div>

              <div className="space-y-1.5 font-sans">
                <label htmlFor="contact-note" className="text-[10px] text-brand-maroon font-bold uppercase tracking-wider block">{t("contact_form_note")}</label>
                <textarea
                  rows={4}
                  placeholder={t("contact_form_note_placeholder")}
                  value={formInp.note}
              ...
              {submitted && (
                <div className="bg-[#E7F3EC] border border-[#2E7D32]/25 p-4 rounded-none text-center">
                  <span className="text-[#2E7D32] block font-semibold">{t("contact_form_success")}</span>
